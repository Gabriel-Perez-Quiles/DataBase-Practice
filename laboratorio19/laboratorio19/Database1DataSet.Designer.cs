...
namespace laboratorio19.Database1DataSetTableAdapters {
    ...
    public partial class userTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `user` WHERE ((`ID` = ?) AND ((? = 1 AND `user` IS NULL) OR (`user` =" +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `user` SET `user` = ?, `password` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `u" +
                "ser` IS NULL) OR (`user` = ?)) AND ((? = 1 AND `password` IS NULL) OR (`password" +
                "` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::laboratorio19.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, [user], [password] FROM [user]";
